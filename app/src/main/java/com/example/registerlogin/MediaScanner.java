...
public class MediaScanner {
    ...
    private static volatile com.example.registerlogin.MediaScanner mMediaInstance = null;
    private MediaScannerConnection mMediaScanner;
    //private                 MediaScannerConnection.MediaScannerConnectionClient mMediaScannerClient;

    private String mFilePath;

    public static com.example.registerlogin.MediaScanner getInstance(Context context ) {
        if( null == context )
            return null;

        if( null == mMediaInstance )
            mMediaInstance = new com.example.registerlogin.MediaScanner( context );
